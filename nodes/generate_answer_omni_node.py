...
class GenerateAnswerOmniNode(BaseNode):
    ...
    def execute(self, state: dict) -> dict:
        ...
        # print("################################")
        # print(state['img_urls'])
        # print("################################")
        chains_dict = {}
        # imag_desc = dict(enumerate(state['doc'].metadata.get("img_urls", [])))
        # print("*******************************")
        # print(imag_desc)
        # print("******************************")
        # for idx, d in enumerate(doc):
        #     for i, img_url in enumerate(d.metadata.get("img_urls", [])):
        #         d.page_content = d.page_content.replace(img_url, f"<Image_ID: {i}>")
        #     d.metadata["img_urls"] = {i: img_url for i, img_url in enumerate(d.metadata.get("img_urls", []))}
        #     doc[idx] = d
        # print("################################")
        # print(doc)
        # print("################################")
        if len(doc) == 1:
            imag_desc = dict(enumerate(state['img_urls']))
            print("*******************************")
            print(imag_desc)
            print("******************************")
